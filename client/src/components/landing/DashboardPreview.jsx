  ...
  return (
    <div className="py-6 px-0 text-center relative overflow-hidden" id="preview">
      ...
      <div className="relative max-w-5xl mx-auto">
        {/* Browser Shell */}
        <div className="relative rounded-[1.75rem] border border-border bg-surface p-1.5 shadow-[0_0_80px_rgba(74,222,128,0.07)] hover:shadow-[0_0_120px_rgba(74,222,128,0.12)] transition-shadow duration-500">
          ...
          <div className="flex items-center gap-2 px-5 py-3.5">
            ...
            <div className="flex-1 max-w-xs mx-auto h-6 rounded-full bg-text/5 border border-text/5 flex items-center px-3">
              <span className="text-[10px] text-muted-2 font-mono select-none">app.invoicesync.in/seller/dashboard</span>
            </div>
            ...
            {!imgError ? (
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                <div className="w-full px-6 max-w-2xl">
                  ...
                  <div className="h-40 rounded-xl bg-surface-2 border border-border animate-pulse" />
                </div>
                <p className="text-muted-2 text-xs font-medium mt-2">Dashboard Preview Coming Soon</p>
              </div>
            )}
          </div>
        </div>
