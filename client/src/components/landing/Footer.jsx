...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#FDFBF7] relative overflow-hidden border-t border-[#E5E2D9]">
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[300px] bg-[#047857]/5 rounded-full blur-[130px] pointer-events-none" />
      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-8 pt-16 pb-10 relative z-10">
        ...
        <div className="flex flex-col items-center mb-12 lg:hidden">
          ...
          <p className="text-[11px] text-[#4D6357] leading-relaxed max-w-[220px] text-center" style={{ fontFamily: 'Inter, sans-serif' }}>
        ...
        <div className="grid grid-cols-3 lg:grid-cols-4 gap-x-4 sm:gap-x-8 gap-y-10 lg:gap-8">
          ...
          <div className="hidden lg:flex flex-col items-center">
            ...
            <p className="text-[11px] text-[#4D6357] leading-relaxed max-w-[200px] text-center" style={{ fontFamily: 'Inter, sans-serif' }}>
              The smartest way for Indian businesses to collaborate on invoices — GST-ready, real-time, and built for scale.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <ul className="space-y-2.5 text-center">
              {productLinks.map((item) => (
                <li key={item}>
                  <Link to="/" className="text-[10px] sm:text-[11px] uppercase tracking-[0.10em] text-[#4D6357] hover:text-[#047857] transition-colors duration-200">
                    {item}
                  </Link>
                </li>
              ))}
        ...
        <div className="flex flex-col items-center gap-1 pt-8 pb-10 relative z-10 w-full max-w-sm mx-auto px-6">
          ...
          <div className="w-full flex">
            <input
              ...
              className="bg-[#FFFFFF] border border-[#E5E2D9] border-r-0 rounded-l-xl px-4 py-2.5 text-sm text-[#0A2518] placeholder-[#728279] flex-1 min-w-0 outline-none focus:border-[#047857]/40 transition-colors"
            />
      ...
      {/* ── Bottom bar ── */}
      <div className="mx-auto max-w-7xl px-6 sm:px-8 py-5 flex flex-col sm:flex-row items-center justify-between border-t border-[#E5E2D9] relative z-10 gap-4">
